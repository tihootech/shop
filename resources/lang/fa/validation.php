...
return [
    ...
    */
    ...
    'custom' => [
        'name.*' => [
            'unique' => ' لطفا از نام تکراری برای محصولات خود استفاده نکنید. زیرا استفاده از نام های تکراری مخاطبان شما را گنگ میکند.',
        ],
        'state' => [
            'required' => 'لطفا استان محل اقامت خود را مشخص کنید.',
        ],
        'video_path.*' => [
            'mimes' => ' ویدیو باید mp4 باشد و کمتر از 50 مگابایت حجم داشته باشد.',
            'max' => ' ویدیو باید mp4 باشد و کمتر از 50 مگابایت حجم داشته باشد.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'card_number.0' => 'چهار رقم اول شماره کارت',
        'card_number.1' => 'چهار رقم دوم شماره کارت',
        'card_number.2' => 'چهار رقم سوم شماره کارت',
        'card_number.3' => 'چهار رقم چهارم شماره کارت',
        'owner_name'=> 'نام صاحب حساب',
        'shaba'=> 'شماره شبا',
        'bank_name'=> 'نام بانک',
        'bank_branch'=> 'شعبه بانک',
        'bank_code'=> 'کد بانک',
        'payment_uid'=> 'شناسه پرداخت',
        'modes'=> 'حالت',
        'name'=> 'نام',
        'card_uid'=> 'کارت باشگاه مشتریان',
        'postcode'=> 'کدپستی',
        'image_path.*'=> 'تصویر آپلود شده',
        'logo_path.*'=> 'لوگو آپلود شده',
        'bg_path.*'=> 'تصویر پس زمینه آپلود شده',
        'club_discount_percent'=> 'درصد تخفیف باشگاه مشتریان',
        'club_discount_amount'=> 'مقدار نخفیف باشگاه مشتریان',
        'club_gift_percent'=> 'درصد اعتبار هدیه',
        'club_gift_amount'=> 'مقدار اعتبار هدیه',
        'student_name'=> 'نام شاگرد',
        'student_mobile'=> 'موبایل شاگرد',
        'student_uid'=> 'کارت اسکن شده',
        'pwd '=> 'رمزعبور',
    ],
